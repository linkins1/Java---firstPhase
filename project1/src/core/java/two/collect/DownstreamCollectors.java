...
public class DownstreamCollectors {
    ...
    public static Stream<City> readCities(String filename) throws IOException {
        return Files.lines(Paths.get(filename)).map(l -> l.split(", ")).map(
                a -> new City(a[0], a[1], Integer.parseInt(a[2]))
        );
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        Stream<City> cities = readCities("C:\\Users\\123\\Desktop\\cities");
        ...
        cities = readCities("C:\\Users\\123\\Desktop\\cities");
